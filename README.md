...
🎓 IIT (ISM) Dhanbad 
💻  *Full-Stack Developer* | AI Engineer | Backend Developer | Forward Deployed engineer
🌏 Open to opportunities in *India 🇮🇳*  

---

## 🚀 About Me
- 🔭 Currently building *scalable full-stack apps* with *MERN , Springboot, FastApi and Next.js*  
- 🤖 Exploring *AI integration* (Gemini, Claude, Chatgpt, NLP, MCP, Ai agents) into web apps  
